...
Dhani.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      teks = `_ℚ𝕝𝕢 𝕞𝕖𝕟𝕠𝕝_*@${num.split('@')[0]}*
𝑩𝑰𝑬𝑵𝑽𝑬𝑵𝑰𝑫𝑶𝑺 𝑨:❝ *${mdata.subject}* ❞

⚸• 𝐅𝐨𝐭𝐨.
⚸• 𝐍𝐨𝐦𝐛𝐫𝐞.
⚸• 𝐄𝐝𝐚𝐝.

𝑺𝑰 𝑬𝑹𝑬𝑺 𝑷𝑬𝑹𝑼𝑨𝑵𝑶 𝑺𝑨𝑳𝑻𝑬 𝑶 𝑻𝑬 𝑬𝑳𝑰𝑴𝑰𝑵𝑶, 𝑴𝑴𝑮𝑼𝑬𝑽𝑨𝒁𝑶.`
      welcomeBut = [{buttonId:`#menu`,buttonText:{displayText:'menu'},type:1}, {buttonId:`#infogroup`,buttonText:{displayText:'infogroup'},type:1}]
      welcomeButt = { contentText: `${teks}`, footerText: `𝙉𝙤 𝙩𝙚 𝙫𝙚𝙣𝙜𝙖𝙨 𝙖 𝙝𝙖𝙘𝙚𝙧 𝙚𝙡 𝙥𝙞𝙤𝙡𝙖 𝙂𝙞𝙡`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `𝙑𝙖𝙮𝙖𝙨𝙚 𝙖 𝙡𝙖 𝙫𝙚𝙧𝙜𝙖 !`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
